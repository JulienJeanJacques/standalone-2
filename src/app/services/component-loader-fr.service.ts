...
import { ComponentMappingD1 }  from '../interfaces/loaderTypesFr/d/d1/componentMapping-d1';
import { ComponentMappingD2 }  from '../interfaces/loaderTypesFr/d/d2/componentMapping-d2';

@Injectable({
  providedIn: 'root'
})
export class ComponentLoaderFrService {
  private k: string;
